...
import com.djm.gulimall.ware.feign.MemberFeignService;
import com.djm.gulimall.ware.vo.FareVo;
import com.djm.gulimall.ware.vo.MemberAddressVo;
...
import com.djm.gulimall.ware.dao.WareInfoDao;
...
public class WareInfoServiceImpl extends ServiceImpl<WareInfoDao, WareInfoEntity> implements WareInfoService {
    ...
    public FareVo getFare(Long addrId) {
        ...
        if (memberAddressVo != null) {
            ...
            //1558022051
            String fare = phone.substring(phone.length() - 11, phone.length()-9);
